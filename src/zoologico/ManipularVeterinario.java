...
public class ManipularVeterinario extends ManipularZoologico {
    ...
    public Veterinario leerVeterinario(String id) {
        ...
        // Si values devuelve un null entonces no encontró el id y tienes que regresar
        // un null
        return null;
    }
    ...
    public boolean inserta(Veterinario veretrinario) {
        ...
        // El numero de telefono y los emails, debes separarlos y pasar toda la entidad
        // en string y un RFC formato "nombre,blabla,blalbal,blalbla,blalba," (checa los
        // archivos csv)
        return this.inserta("RFC", "ENTIDADXD");// Valores de ejemplo
    }

    public boolean editar(Veterinario veterinario, String id) {
        // Del objeto Veterinario pasado con el id obtener sus propiedades y editar

        return this.editar(veterinario, id);
    }
