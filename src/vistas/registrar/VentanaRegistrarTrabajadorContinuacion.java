...
public class VentanaRegistrarTrabajadorContinuacion extends JPanel {
	...
	public VentanaRegistrarTrabajadorContinuacion() {
				...
				switch (opcionTrabajador) {
					case "Veterinario": {
						...
						VentanaRegistrarTrabajador.changePrincipalPanel(
								ventanaRegistrarTrabajador.getVentanaRegistrarVeterinario().getPanelPrincipal());
						break;
					}
					case "Cuidador": {
						break;
		...
		comboBoxGenero.setModel(
				new DefaultComboBoxModel<String>(new String[] { "", "Masculino", "Femenino", "No Binario", "" }));
		...
		comboBoxTipoTrabajador.setModel(
				new DefaultComboBoxModel<String>(new String[] { "", "Veterinario", "Cuidador", "Proveedor" }));
