	...
	public VentanaRegistrarBiomas() {
		...
		buttonRegistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(comboBoxServicios.getSelectedItem().equals(comboBoxServicios.getItemAt(0)) || comboBoxTipoBioma.getSelectedItem().equals(comboBoxTipoBioma.getItemAt(0))) {
					JOptionPane.showMessageDialog(null,"Selecciona una opcion en 'Tipo de Biona' y 'Servicios'","Error",JOptionPane.ERROR_MESSAGE);
				}
				...
				if(bandera) {
					JOptionPane.showMessageDialog(null,"Ingresa un input valido (no espacios ni caracteres especiales)","Error",JOptionPane.ERROR_MESSAGE);
				}
